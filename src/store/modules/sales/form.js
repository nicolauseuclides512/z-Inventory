...
const mutations = {
  ...
  CONTACT(state, payload) {
    if (payload) {
      ...
      state.email = payload.email.toLowerCase()
      state.phone = payload.phone
      state.mobile = payload.mobile
      state.contact_id = payload.contact_id
      state.invoice_email = payload.invoice_email.toLowerCase()
  ...
  EMAIL(state, payload) { state.email = payload.toLowerCase() },
  ...
  INVOICE_EMAIL(state, payload) { state.invoice_email = payload.toLowerCase() },
