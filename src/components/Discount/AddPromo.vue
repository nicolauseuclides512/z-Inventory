  ...
  <div>
    ...
    <form method="POST" @submit.prevent="save">
      ...
      <div class="container full-width-header bt-1 p-b-10 m-b-20">
        <div class="row">
          <div class="col-md-12">
            <h4 class="pull-left page-title">New Promo</h4>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12 p-b-20">
            <div class="form-horizontal">
              ...
              <div class="form-group form-general m-b-20">
                ...
                <div class="col-md-3">
                  <input type="text" class="form-control" id="start_date" v-model="form.start_date">
                </div>
                <label class="col-md-2 control-label text-left">End Date</label>
                <div class="col-md-3">
                  <input type="text" class="form-control" id="end_date" v-model="form.end_date">
                </div>
              </div>
              <div class="form-group form-general m-b-20">
                <div class="col-md-7 col-md-offset-3">
                  <div class="checkbox checkbox-success">
                    <input type="checkbox" v-model="form.no_expiry" :true-value="1" :false-value="0" id="no-expiry">
                    <label for="no-expiry"> No Expiry</label>
                  </div>
                </div>
              </div>
              <div class="form-group form-general m-b-20">
                ...
                <div class="col-md-7">
                  ...
                  <div class="radio radio-info radio-inline radio-inline-input ml-20">
                    <input type="radio" id="input-quantity" v-model="quantity_type" value="input-quantity" name="total-quantity">
                    <label for="input-quantity">
                      <input type="number" id="quantity" v-model="form.quantity" class="form-control" min="0" :disabled="quantity_type == 'unlimited'">
                    </label>
                  </div>
                </div>
              </div>
      ...
      <div class="container p-b-10 m-b-20">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <button type="button" class="btn btn-default waves-effect" @click="backToList">Cancel</button>
          </div>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      getCollection(search) {
        ...
        this.$http.get('collections', { params: options })
          .then(res => {
            if ([0, 200, 201].indexOf(res.data.code) === -1) return
