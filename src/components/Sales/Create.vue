<template>
  <form action="POST" @submit.prevent>
    <div>
      <h2 class="lead">Create Sales Order</h2>
      <hr>
          ...
          <tr class="total text-bold">
            ...
            <td colspan="3">
              <div class="input-group pull-right">
                ...
                <input type="text" maxlength="20" class="form-control form-white text-right" style="max-width: 100%;"
                       placeholder="" v-model="formatted_adjustment_value">
              </div>
            </td>
          </tr>
          <tr class="total text-bold">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      formatted_adjustment_value: {
        get() { return numeral(this.form.adjustment_value).format('0,0') },
        set(value) { this.form.adjustment_value = value.replace(/\./g, '').replace(/,/g, '') },
      },
    ...
    methods: {
      ...
      async save (evt) {
        try {
          ...
          switch (evt.target.dataset.value) {
            ...
            case 'save_as_draft':
              Router.replace({name: 'sales.edit', params: {id: sales_order_id}})
              break
      ...
      clearForm() {
        ...
        this.form.invoice_date = dateFormat(new Date(), 'YYYY-MM-DD')
        this.form.due_date = null
        this.form.contact_id = null
        this.form.sales_order_date = dateFormat(new Date(), 'YYYY-MM-DD')
        this.form.shipment_date = null
        this.form.carrier_id = null
        this.form.discount_contact_id = null
        this.form.discount_amount_type = 'fixed'
        this.form.discount_amount_value = 0
        this.form.shipping_weight = 1
        this.form.shipping_weight_unit = 'gr'
        this.form.shipping_rate = 0
        this.form.adjustment_name = ''
        this.form.adjustment_value = 0
        this.form.internal_notes = ''
        this.form.customer_notes = ''
        this.form.term_date = dateFormat(new Date(), 'YYYY-MM-DD')
        this.form.invoice_email = ''
        this.form.billing_address = ''
        this.form.billing_region = null
        this.form.billing_district = null
        this.form.billing_province = null
        this.form.billing_country = null
        this.form.billing_zip = null
        this.form.billing_fax = null
        this.form.shipping_address = ''
        this.form.shipping_region = null
        this.form.shipping_district = null
        this.form.shipping_province = null
        this.form.shipping_country = null
        this.form.shipping_zip = null
        this.form.shipping_fax = null
        this.form.tax_included = 1
