		...
		<div v-else>
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12" v-if="!checkedList.length > 0">
									...
									<ul class="dropdown-menu" role="menu" style="top: 35px;">
										...
										<li :class="{ active: filter === 'all' }"><a href="javascript:void(0);" @click="getList({ filter: 'all' })">All</a></li>
										<li class="divider"></li>
										<li :class="{ active: filter === 'draft' }"><a href="javascript:void(0);" @click="getList({ filter: 'draft' })">Draft</a></li>
										<li :class="{ active: filter == 'paid' }"><a href="javascript:void(0);" @click="getList({ filter: 'paid' })">Paid</a></li>
										<li :class="{ active: filter == 'unpaid' }"><a href="javascript:void(0);" @click="getList({ filter: 'unpaid' })">Unpaid</a></li>
										<li :class="{ active: filter == 'partially_paid' }"><a href="javascript:void(0);" @click="getList({ filter: 'partially_paid' })">Partially Paid</a></li>
										<li :class="{ active: filter == 'overdue' }"><a href="javascript:void(0);" @click="getList({ filter: 'overdue' })">Overdue</a></li>
										...
										<li :class="{ active: filter == 'void' }"><a href="javascript:void(0);" @click="getList({ filter: 'void' })">Void</a></li>
									</ul>
									<div class="pull-right">
										...
										<ul class="dropdown-menu" role="menu" style="top: 35px;">
											...
											<li :class="{ active: sort.startsWith('created_at') }"><a href="javascript:void(0);" @click="getList({ sort: 'created_at.asc' })">Created Time</a></li>
											<li :class="{ active: sort.startsWith('updated_at') }"><a href="javascript:void(0);" @click="getList({ sort: 'updated_at.asc' })">Last Modified Time</a></li>
											<li :class="{ active: sort.startsWith('order_date') }"><a href="javascript:void(0);" @click="getList({ sort: 'order_date.asc' })">Date</a></li>
											<li :class="{ active: sort.startsWith('invoice_number') }"><a href="javascript:void(0);" @click="getList({ sort: 'invoice_number.asc' })">Invoice#</a></li>
											<li class="divider"></li>
						...
						<div class="row" v-if="salesOrder">
							<div class="col-md-12">
								<h3 class="pull-left page-title">
									...
									<small class="label label-success" v-if="salesOrder.invoice_status === 'PAID'">{{ salesOrder.invoice_status }}</small>
			...
			<div class="row">
				<div class="col-md-12 p-0">
								...
								<div class="row p-20 pb-0">
									<div class="btn-toolbar" role="toolbar">
										<div class="btn-group" role="group">
											<button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="View as PDF" @click="viewInvoice"><i class="fa fa-file-pdf-o"></i></button>
											<button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Print" @click="viewInvoice"><i class="fa fa-print"></i></button>
											<button
											type="button"
											...
											<tr v-for="payment in paymentList" v-show="paymentList.length > 0">
												...
												<td>
													<div class="clearfix">
														...
														<div class="pull-right">
															<a class="btn btn-default btn-sm" href="javascript:void(0);" title="Delete this payment" @click="deletePayment(payment)"><i class="fa fa-trash"></i></a>
														</div>
													</div>
												</td>
											</tr>
					...
					<!--<div :class="{ 'tab-pane': true, active: currentTab == 'shipment' }" id="shipment" v-if="currentTab == 'shipment'">-->
					<!--<div class="container">-->
					<!--<div class="row p-20 pb-0">-->
					...
					<!--&lt;!&ndash;<button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="View package list and shipment label"><i class="fa fa-file-pdf-o"></i></button>&ndash;&gt;-->
					...
					<!--&lt;!&ndash;<span class="caret" data-toggle="tooltip" data-placement="top" title="More options"></span>&ndash;&gt;-->
					<!--&lt;!&ndash;<span class="sr-only">Toggle Dropdown</span>&ndash;&gt;-->
					<!--&lt;!&ndash;</button>&ndash;&gt;-->
					<!--&lt;!&ndash;<ul class="dropdown-menu">&ndash;&gt;-->
					<!--&lt;!&ndash;<li><a href="javascript:void(0)" data-toggle="tooltip" data-placement="top">View package list</a></li>&ndash;&gt;-->
					<!--&lt;!&ndash;<li><a href="javascript:void(0)" data-toggle="tooltip" data-placement="top">View shipment label</a></li>&ndash;&gt;-->
					<!--&lt;!&ndash;</ul>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->

					<!--&lt;!&ndash;<div class="btn-group">&ndash;&gt;-->
					<!--&lt;!&ndash;<button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Print package list and shipment label"><i class="fa fa-print"></i></button>&ndash;&gt;-->
					<!--&lt;!&ndash;<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">&ndash;&gt;-->
					<!--&lt;!&ndash;<span class="caret" data-toggle="tooltip" data-placement="top" title="More options"></span>&ndash;&gt;-->
					<!--&lt;!&ndash;<span class="sr-only">Toggle Dropdown</span>&ndash;&gt;-->
					<!--&lt;!&ndash;</button>&ndash;&gt;-->
					<!--&lt;!&ndash;<ul class="dropdown-menu">&ndash;&gt;-->
					<!--&lt;!&ndash;<li><a href="javascript:void(0)" data-toggle="tooltip" data-placement="top" >Print package list</a></li>&ndash;&gt;-->
					<!--&lt;!&ndash;<li><a href="javascript:void(0)" data-toggle="tooltip" data-placement="top" >Print shipment label</a></li>&ndash;&gt;-->
					<!--&lt;!&ndash;</ul>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					...
					<!--&lt;!&ndash;v-show="shipmentList.length > 0"&ndash;&gt;-->
					<!--&lt;!&ndash;@click="deleteShipment"&ndash;&gt;-->
					<!--&lt;!&ndash;&gt;&ndash;&gt;-->
					...
					<!--</div>-->
					<!--</div>-->
					<!--&lt;!&ndash;<div v-if="shipmentList.length == 0" class="text-center" style="padding-top: 60px">&ndash;&gt;-->
					<!--&lt;!&ndash;<h3>No shipment yet</h3>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;<div v-else>&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="row p-20 m-b-20">&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="col-md-12">&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="row mb-15">&ndash;&gt;-->
					<!--&lt;!&ndash;<label class="col-md-4 control-label text-left"><strong>Shipment Order#</strong></label>&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="col-md-7">&ndash;&gt;-->
					<!--&lt;!&ndash;{{ shipmentList[0].shipment_order_number }}&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="row mb-15">&ndash;&gt;-->
					<!--&lt;!&ndash;<label class="col-md-4 control-label text-left"><strong>Date of Shipment</strong></label>&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="col-md-7">&ndash;&gt;-->
					<!--&lt;!&ndash;{{ shipmentList[0].date | date('short') }}&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="row mb-15">&ndash;&gt;-->
					<!--&lt;!&ndash;<label class="col-md-4 control-label text-left"><strong>Carrier</strong></label>&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="col-md-7">&ndash;&gt;-->
					<!--&lt;!&ndash;{{ shipmentList[0].carrier.name }}&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="row mb-15">&ndash;&gt;-->
					<!--&lt;!&ndash;<label class="col-md-4 control-label text-left"><strong>Tracking</strong></label>&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="col-md-7">&ndash;&gt;-->
					<!--&lt;!&ndash;<span class="text-muted">#</span> {{ shipmentList[0].tracking_number }}&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="row mb-15">&ndash;&gt;-->
					<!--&lt;!&ndash;<label class="col-md-4 control-label text-left"><strong>Status</strong></label>&ndash;&gt;-->
					<!--&lt;!&ndash;<div class="col-md-7">&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<span class="label label-info">{{ shipmentList[0].is_delivered ? 'Delivered' : 'Not delivered yet' }}</span>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<small class="label label-success" v-if="salesOrder.shipment_status === 'SHIPPED'">{{ salesOrder.shipment_status | removeUnderScore }}</small>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<small class="label label-danger" v-else>{{ salesOrder.shipment_status | removeUnderScore }}</small>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;</div>&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="row p-20 btop-1">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="col-md-12">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="row mb-15">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<label class="col-md-4 control-label text-left"><strong>Recipient</strong></label>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="col-md-7">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<a href="javascript:void(0);">{{ salesOrder.contact ? salesOrder.contact.display_name : '' }}</a>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="row mb-15">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<label class="col-md-4 control-label text-left"><strong>Shipment Address</strong></label>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="row mb-15">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<label class="col-md-4 control-label text-left light">Alamat</label>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="col-md-7">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;{{ salesOrder.shipping_address }}&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="row mb-15">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<label class="col-md-4 control-label text-left light">Region</label>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="col-md-7">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;{{ shipping_region_name }}&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="row mb-15">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<label class="col-md-4 control-label text-left light">District</label>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="col-md-7">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;{{ shipping_district_name }}&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="row mb-15">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<label class="col-md-4 control-label text-left light">Province</label>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="col-md-7">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;{{ shipping_province_name }}&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="row mb-15">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<label class="col-md-4 control-label text-left light">Kode Pos</label>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="col-md-7">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;{{ salesOrder.shipping_zip }}&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="row mb-15">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<label class="col-md-4 control-label text-left light">Country</label>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;<div class="col-md-7">&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;{{ shipping_country_name }}&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
					<!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
...
mounted() {
  ...
  computed: {
  	...
  	shipmentList: {
  		get() { return store.state.sales.shipmentList },
