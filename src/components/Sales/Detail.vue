                    ...
                    <div class="container">
                      <div class="row p-20 pb-0">
                        <div class="btn-toolbar" role="toolbar" aria-label="shipment">
                          ...
                          <div class="btn-group">
                            <button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="top"
                                    title="View package list and shipment label"><i class="fa fa-file-pdf-o"></i>
                            </button>
                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                              <span class="caret" data-toggle="tooltip" data-placement="top"
                                    title="More options"></span>
                              <span class="sr-only">Toggle Dropdown</span>
                            </button>
                            <ul class="dropdown-menu">
                              <li><a href="javascript:void(0)" data-toggle="tooltip" data-placement="top">View package list</a>
                              </li>
                              <li><a href="javascript:void(0)" data-toggle="tooltip" data-placement="top">View shipment label</a>
                              </li>
                            </ul>
                          </div>
                          ...
                          <div class="btn-group">
                            <button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="top"
                                    title="Print package list and shipment label"><i class="fa fa-print"></i></button>
                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                              <span class="caret" data-toggle="tooltip" data-placement="top"
                                    title="More options"></span>
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="javascript:void(0)" data-toggle="tooltip" data-placement="top">Print package list</a>
                              </li>
                              <li><a href="javascript:void(0)" data-toggle="tooltip" data-placement="top">Print shipment label</a>
                              </li>
                            </ul>
                          </div>
                      ...
                      <div v-if="shipmentList.length == 0" class="text-center" style="padding-top: 60px">
                        ...
                        <div class="row p-20 m-b-20">
                          <div class="col-md-12">
                            ...
                            <div class="row mb-15">
                              ...
                              <div class="col-md-7">
                      <span class="label label-info">{{ shipmentList[0].is_delivered ? 'Delivered' : 'Not delivered yet'
                        }}</span>
                        ...
                        <div class="row p-20 btop-1">
                          <div class="col-md-12">
                            <div class="row mb-15">
                              <label class="col-md-4 control-label text-left"><strong>Recipient</strong></label>
                              <div class="col-md-7">
                                <a
                                  href="javascript:void(0);">{{ salesOrder.contact ? salesOrder.contact.display_name : ''
                                  }}</a>
                              </div>
                            </div>
                            <div class="row mb-15">
